...
STR = {
    ...
    lede:"Ennusteet, merituuli ja live-aaltodata — suoraan Ilmatieteen laitoksen omasta avoimesta datasta, ei globaalista mallista. Kaikki alla on live-dataa juuri nyt. Nyt saatavilla Connect IQ -kaupassa.",
    tagDev:"v1.0.0", tagArea:"Suomi",
    navLive:"Live-data", navWhat:"Ominaisuudet", navData:"Data",
    ...
    footNote:"FIWeatherWatch on itsenäinen projekti, ei Ilmatieteen laitoksen eikä Garminin tukema. Ajat Suomen aikaa. Palaute on tervetullutta.",
    ...
    navApp:"Sovellus", navWeather:"Säätiedot", navLiveWeather:"Live-sää", brandWeather:"Sää", tagLive:"Live-data", navApp2:"Sovellus",
  ...
  sv: {
    ...
    lede:"Prognoser, havsvind och live-vågdata — direkt från Meteorologiska institutets egna öppna data, inte en global modell. Allt nedan är live just nu. Finns nu i Connect IQ Store.",
    tagDev:"v1.0.0", tagArea:"Finland",
    navLive:"Livedata", navWhat:"Funktioner", navData:"Data",
    ...
    footNote:"FIWeatherWatch är ett fristående projekt, utan koppling till Meteorologiska institutet eller Garmin. Tider i finsk lokaltid. Återkoppling välkomnas.",
    ...
    navApp:"Appen", navWeather:"Väderdata", navLiveWeather:"Live-väder", brandWeather:"Väder", tagLive:"Live-data", navApp2:"Appen",
  ...
  en: {
    ...
    lede:"Forecasts, marine wind and live wave data — from the Finnish Meteorological Institute's own open data, not a global model. Everything below is live right now. Available now on the Connect IQ Store.",
    tagDev:"v1.0.0", tagArea:"Finland",
    navLive:"Live data", navWhat:"Features", navData:"Data",
    ...
    footNote:"FIWeatherWatch is an independent project, not affiliated with or endorsed by the Finnish Meteorological Institute or Garmin. Times in Finnish local time. Feedback welcome.",
    ...
    navApp:"The app", navWeather:"Weather data", navLiveWeather:"Live weather", brandWeather:"Weather", tagLive:"Live data", navApp2:"The app",
...
function renderNavCta() {
  ...
  host.innerHTML = STORE_URL
    ...
    : WEATHER_ONLY
      ? `<a class="btn blueprint" href="${APP_URL}"
           style="text-transform:uppercase;letter-spacing:0.06em">${T("navApp2")}
           <i class="corner tl"></i><i class="corner tr"></i>
           <i class="corner bl"></i><i class="corner br"></i></a>`
      : `<span class="btn blueprint" style="text-transform:uppercase;
           letter-spacing:0.06em;color:var(--color-neutral-600);cursor:default">${T("soon")}
           <i class="corner tl"></i><i class="corner tr"></i>
           <i class="corner bl"></i><i class="corner br"></i></span>`;
}
...
function applyStrings() {
  ...
  // Last, deliberately: the generic set() pass below would otherwise put
  // "Live data" back over this and point it at an anchor on a page that no
  // longer has one.
  if (!WEATHER_ONLY) {
    const nav = $("#nav-live");
